...
export function SpinnerCard({ item }: { item: SpinnerItem }) {
  ...
  return (
    <Link className="link-outline group rounded-3xl" href={item.href}>
      <div className="relative flex h-52 flex-col items-center justify-center rounded-3xl border border-border bg-background-subtle p-1 transition-colors duration-200 ease-out group-hover:bg-background">
