...
Available: `Arc`, `Atom`, `Blocks`, `BouncingDots`, `Chase`, `CircularDots`, `Classic`, `ClassicV2`, `Clock`, `Comet`, `Compass`, `Dual`, `FigureEight`, `Flip`, `LinearDots`, `Loading`, `Morph`, `Orbit`, `Pendulum`, `Pulse`, `Radar`, `Ring`, `Ripple`, `Snake`, `Swirl`, `Trace`, `Wave`.
