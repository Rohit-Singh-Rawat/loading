...
Available: `Arc`, `Atom`, `Blocks`, `BouncingDots`, `CircularDots`, `Classic`, `ClassicV2`, `Clock`, `Comet`, `Compass`, `Ellipsis`, `Hourglass`, `LinearDots`, `Orbit`, `Pie`, `Pulse`, `Radar`, `Ring`, `Ripple`, `Swirl`, `Wave`.
