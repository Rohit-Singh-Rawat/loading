...
Render as a code block bar chart. Bar width is proportional to percentage using `█` for filled and `░` for empty, 25 characters total width. Right-align counts and percentages, round percentage to nearest 4% increment.
